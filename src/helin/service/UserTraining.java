 ...
 * UserTraining.java
 * 
 * @description some operations about training set including storing all rating
 *              data and calculate similarity between users.
 * 
 */
public class UserTraining {
	...
	public void GetUMList(List<User> userList, List<Movie> movieList) {
		...
		infoList = ReadFileUtil.ReadFileByLine("res/user_social.txt");
		size = infoList.size();
	 ...
	 * 
	 */
	public byte[][] GetTrainingSet(String sFileName, List<User> userList,
